...
public class AdminController {
    ...
    public ResponseEntity<?> getOrdersCountedMonthly(@RequestParam(required = false) @DateTimeFormat(pattern = "yyyy-MM") YearMonth date) {
        if (date != null) {
    ...
    public ResponseEntity<?> getOrdersTotalPriceMonthly(@RequestParam(required = false) @DateTimeFormat(pattern = "yyyy-MM") YearMonth date) {
        if (date != null) {
